...
from testing.db_tests import test_init_db, test_get_inventory_exists, test_dict_factory_link, test_check_connection_threaded, test_apple_stock, test_banana_stock, test_mango_stock
...
DB_FUNCS = [test_init_db, test_get_inventory_exists,
            ...
            test_check_connection_threaded, test_apple_stock,
            test_banana_stock, test_mango_stock]
